...
{ cout<< "            _________________________________________________________"<<endl;
  cout<< "            *********************************************************"<<endl;
  cout<< "            *                                                       *"<<endl;
  cout<< "            *          ---> STUDENT MENAGEMENT SYSTEM <---          *"<<endl;
  cout<< "            *                                                       *"<<endl;
  cout<< "            *       PROJECT BY :                                    *"<<endl;
  cout<< "            *                    MUHAMMAD MAAZ ABBAS                *"<<endl;
  cout<< "            *                      2020-ag-5560                     *"<<endl;
  cout<< "            *       Submitted to :                                  *"<<endl;
  cout<< "            *                     Dr. KHALIL UR REHMAN              *"<<endl;
  cout<< "            *                                                       *"<<endl;
  cout<< "            *                                    BS'CS 3rd (A)      *"<<endl;
  ...
  cout<< "            *********************************************************"<<endl;
	...
	while (option != 6) {
		...
		if (option == 1) {
			...
			while (infile >> data) {
				if (strcmp(data, regno) == 0) {
					...
					infile >> data;
					cout << "CS-405 mark: " << data
						<< endl;

					infile >> data;
					cout << "CS-409 mark: " << data
						<< endl;
		...
		// database of a student.
			...
			cin >> subcode;
			string code1 = "CS-409", code2 = "CS-405",
				mark = "";
			ifstream infile;
			int check = 0;
		...
		// under the same proctor ID.
			...
			while (infile >> temp1) {
				...
				if (strcmp(id, procid) == 0) {
					...
					cout << "CS-405 Mark: " << temp3
						<< endl;
					cout << "CS-409 Mark: " << temp4
						<< endl;
					check = 1;
				}
			}
